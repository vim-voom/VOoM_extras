...
# ID_LEVELS VO.levels=[1, 1, 2, 3, 3, 1, 1, 1, 2, 3, 3, 3, 2, 2, 1, 1, 1, 2, 3, 3, 1, 1, 2, 2, 2, 3, 3, 3, 1, 1, 1, 1]
if 1:
    ### if 1
    if 1:
        def func1(a,
...
def testVoomSort(): #**VoomSort tests**
    def B(): pass
    @func7
    def C(): pass
    def A(): pass
...
### decorator tests
@func7 # start of deCorated() node
### boo
@func4
    # boo
def deCorated(): # <-- headline
    a = 1
    b = [1,
2, # <-- false headline
3]
